...
using CountryVATRateCalculator.Tests.Unit.Helpers;
using Moq;
using NUnit.Framework;
using ILogger = Serilog.ILogger;

namespace CountryVATRateCalculator.Tests.Unit.Services
{
    [TestFixture]
    public class SafeCallServicesUnitTests
    {
        ...
        /// When calling <see cref="SafeCallService.Call(Func{TResult}, Type)"/>
